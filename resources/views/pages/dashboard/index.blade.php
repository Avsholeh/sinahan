            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2">
                        ...
                        <canvas id="myPieChart" width="299" height="245" class="chartjs-render-monitor"
                                style="display: block; width: 299px; height: 245px;"></canvas>
                    </div>
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Hakim
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Jaksa
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Narapidana
                        </span>
                    </div>
                </div>
            </div>
