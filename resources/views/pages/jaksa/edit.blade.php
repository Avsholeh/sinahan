                    ...
                    <form action="{{ route('jaksa.update', $jaksa->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select name="agama" id="agama" class="form-control" aria-describedby="agama_help">
                                ...
                                <option value="Islam"@if($jaksa->agama === 'Islam'){{ ' selected' }}@endif>
                                    Islam
                                </option>
                                <option value="Kristen"@if($jaksa->agama === 'Kristen'){{ ' selected' }}@endif>
                                    Kristen
                                </option>
                                <option value="Budha"@if($jaksa->agama === 'Budha'){{ ' selected' }}@endif>
                                    Budha
                                </option>
                                <option value="Hindu"@if($jaksa->agama === 'Hindu'){{ ' selected' }}@endif>
                                    Hindu
                                </option>
                                <option value="Konghucu"@if($jaksa->agama === 'Konghucu'){{ ' selected' }}@endif>
                                    Konghucu
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control"
                                ...
                                <option
                                    @if($jaksa->jenis_kelamin === 'Pria'){{ 'selected' }}@endif
                                    value="Pria"
                                >Pria
                                </option>

                                <option
                                    @if($jaksa->jenis_kelamin === 'Wanita'){{ 'selected' }}@endif
                                    value="Wanita"
                                >Wanita
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="Aktif" @if($jaksa->status === 'Aktif'){{ 'selected' }}@endif>Aktif
                                </option>
                                <option value="Tidak Aktif" @if($jaksa->status === 'Tidak Aktif'){{ 'selected' }}@endif>
                                    Tidak Aktif
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <img class="mb-2" style="display: block" src="data:image/png;base64,{{ $jaksa->foto }}"
                                 alt="foto"
                                 width="200">
