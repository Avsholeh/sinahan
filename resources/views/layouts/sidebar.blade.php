<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item{{ request()->is('kunjungan') || request()->is('kunjungan/*') ? ' active' : '' }}">
        ...
        <div id="kunjungan"
             class="collapse{{ request()->is('kunjungan') || request()->is('kunjungan/*') ? ' show' : '' }}"
    ...
    @if(auth()->user()->roles === \App\Models\Pengguna::ROLES_USER)
    ...
    @if(auth()->user()->roles === 'TU-PEGAWAI')
        ...
        <li class="nav-item{{ request()->is('pengguna') || request()->is('pengguna/*') ? ' active' : '' }}">
            ...
            <div id="pengguna"
                 class="collapse{{ request()->is('pengguna') || request()->is('pengguna/*') ? ' show' : '' }}"
                 aria-labelledby="headingPages"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
        ...
        <li class="nav-item{{ request()->is('narapidana') || request()->is('narapidana/*') ? ' active' : '' }}">
            ...
            <div id="narapidana"
                 class="collapse{{ request()->is('narapidana') || request()->is('narapidana/*') ? ' show' : '' }}"
                 aria-labelledby="headingPages"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
